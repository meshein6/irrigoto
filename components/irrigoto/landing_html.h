  ...
  <section>
    ...
    <div class="card">
      ...
      <div class="mode-help" id="supply-help" style="margin:0 0 10px">
        ...
        tank, where pressure rises and falls as the pump cycles. If runs start landing
        short or long after turning this on, recalibrate pressure or turn it back off.
      </div>
